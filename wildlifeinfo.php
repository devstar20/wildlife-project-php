...
<head>
    ...
    <title>Wild Life Info</title>
    <link rel="stylesheet" href="css/wildlifeinfo.css">
    <script src="js.js"></script>
    <style>
        section {
            position: relative;
            margin: 12vh 0 0 0;
            background: url(wild-life-info/forest.jpg) no-repeat;
...
<body>
	...
	<section class="wildlifeinfo-section">

    
        <div class="dropdown drop-parrot">
            <button onclick="myFunction()" class="dropbtn parrot">Parrot</button>
